...
var monster2Group,monster3Group,monster4Group,kills,button;
...
function preload(){
 ...
 bang=loadSound("sounds/bang.wav");
 shoot=loadSound("sounds/shoot.wav");
 gover=loadSound("sounds/over.wav");
 hero2=loadAnimation("images/hero2.png");
 bul2=loadImage("images/bullet2.png")
 bulleti=loadImage("images/bullet.png");
 monster11=loadImage("images/monster1.png");
 monster22=loadImage("images/monster2.png");
 monster33=loadImage("images/monster3.png");
 monster44=loadImage("images/monster4.png");
 bonus=loadSound("sounds/bonus.wav");
 over=loadSound("sounds/out.wav");
 spacei=loadAnimation("images/space2.gif");
 jump=loadSound("sounds/jump.wav");
 homeb=loadImage("images/home.png");
 hero1i=loadAnimation("images/hero1.png");
 boy_running=loadAnimation("images/1966250.gif");
 up=loadImage("images/powerup.png");
 boom=loadAnimation("images/boom1.png");
 backImage=loadImage("images/1758033.jpg"); 
 o1=loadImage("images/1.png"); 
 o2=loadImage("images/2.png"); 
 o3=loadImage("images/3.png"); 
 o4=loadImage("images/4.png"); 
 strt=loadImage("images/start.png");
 point=loadImage("images/boy.jpg");
}

function setup() {
 createCanvas(windowWidth,windowHeight);

 button = document.getElementById("creator").style;
  
  back=createSprite(width/2,0,0,0);
  back.addImage(backImage);
  back.scale=3;
  
  home=createSprite(50,100,20,20);
  home.addImage(homeb);
  home.scale=0.1;
...
function draw() {
  ...
  if(gamestate==="level2start"){
    ...
    fill("brown");
    text("2. To shoot monsters press right/left arrow.",100,200);
    fill("blue");
    text("3. Monsters can come anytime, so beware of them.",100,300);
    fill("purple");
    text("4. Press S to start.",100,400);
    if(keyDown("s")){
      gamestate="level2";
      level.play();
    }
...
function spawnObstacles(){
  if(frameCount%100===0){
    ...
    obstacle.velocityX=-6-score1/80;
    obstacle.scale=0.5
    if(select===1){
